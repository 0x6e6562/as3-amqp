...
//   amqp_connection:close(Connection, ConnectionClose).
	...
	/**
	 * This callback interface defines the AMQP events that a client will want to
	 * intercept in processing the flow of the protocol.  
	 */
	public interface AmqpEventHandler
	{
		function onConnectionStart(event:Event);
	}
}